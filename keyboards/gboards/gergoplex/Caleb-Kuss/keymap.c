...
const uint16_t PROGMEM bspc[] = {KC_S, KC_D, COMBO_END};
const uint16_t PROGMEM esc[] = {KC_W, KC_E, COMBO_END};
const uint16_t PROGMEM tab[] = {KC_F, KC_G, COMBO_END};
const uint16_t PROGMEM colon[] = {KC_J, KC_K, COMBO_END};
const uint16_t PROGMEM under_score[] = {KC_M, KC_COMMA, COMBO_END};
combo_t key_combos[] = {
COMBO(bspc, KC_BSPC),
COMBO(esc, KC_ESC),
COMBO(tab, KC_TAB),
COMBO(colon, KC_COLON),
COMBO(under_score, KC_UNDS),
};
    /* Combomap
     *
     * ,-------------------------------.      ,-------------------------------.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SPECIAL] = LAYOUT_split_3x5_3(
         KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,          KC_GRV,  KC_TILD, KC_UNDS, KC_TRNS, KC_BSLS,
         KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_BTN2,          KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_QUOT,
         KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_BTN1,          KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_QUES,
